...
#dis_rate = open('https://github.com/corpuzn12/TED_d_app/blob/main/disrate_annu_agg.csv')

dis_rate= pd.read_csv(https://github.com/corpuzn12/TED_d_app/blob/main/disrate_annu_agg.csv)
